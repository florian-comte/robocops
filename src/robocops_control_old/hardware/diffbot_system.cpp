...
namespace robocops_control
{
      ...
      const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
  {
    ...
    comms_.send_command(
        static_cast<int16_t>(rad_per_sec_to_rpm(gearbox_ratio_ * wheel_l_.command_speed)),
        static_cast<int16_t>(rad_per_sec_to_rpm(gearbox_ratio_ * wheel_r_.command_speed)),
        false,
        false,
        false,
