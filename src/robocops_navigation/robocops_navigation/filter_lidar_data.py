...
class ScanFilter(Node):
    def __init__(self):
        super().__init__('rplidar_scan_filter')
    ...
    def scan_filter_callback(self,msg):
        ...
        points = [r * sin(theta) if (theta < 3.14 or theta > 1.57) else inf for r,theta in zip(msg.ranges, angles)]
...
def main(args=None):
    ...
    scan_filter_instance = ScanFilter()
    rclpy.spin(scan_filter_instance)
    scan_filter_instance.destroy_node()
    rclpy.shutdown()
